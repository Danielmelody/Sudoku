...
* @language en_US
*
* create a new 9*9 html table in html DOM
* @param level :the difficulty of generated sudoku
*/
function createSuduke(level) {
    var table = document.getElementById('board')
    var remind = document.getElementById('remind')
    table.innerHTML = ''
    var lastGrid    // last chosen grid
    var lastValue
    var lastColor = '#ccc'
    ...
    for (var i = 0; i < 9; ++i) {
        ...
        for (var j = 0; j < 9; ++j) {
            ...
            // NOTE:this is a custom event, which will not be emitted by HTML DOM
            ...
            cell.onclick = function(argument) {
                ...
                // I use variable 'touchCount' to judge the state of grid:chosen, setted, give up chosen
                this.touchCount++;
                if (this.touchCount < 3) {
                    ...
                    var self = this
                    var ansSelector = document.createElement('table')   //a new table inside a table grid
